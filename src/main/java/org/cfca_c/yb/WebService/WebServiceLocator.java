...
public class WebServiceLocator extends org.apache.axis.client.Service implements org.cfca_c.yb.WebService.WebService {
    ...
    private java.lang.String WebServiceSoap_address = "http://yb.cfca-c.org/WebService/WebService.asmx";
    ...
    public org.cfca_c.yb.WebService.WebServiceSoap getWebServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public org.cfca_c.yb.WebService.WebServiceSoap getWebServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.cfca_c.yb.WebService.WebServiceSoapStub _stub = new org.cfca_c.yb.WebService.WebServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.cfca_c.yb.WebService.WebServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                org.cfca_c.yb.WebService.WebServiceSoapStub _stub = new org.cfca_c.yb.WebService.WebServiceSoapStub(new java.net.URL(WebServiceSoap_address), this);
                _stub.setPortName(getWebServiceSoapWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://yb.cfca-c.org/WebService/", "WebService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://yb.cfca-c.org/WebService/", "WebServiceSoap"));
        }
